                        ...
                        <div class="card-body">
                            <table id="datatablesSimple" class="table table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    try {
                                        $sql = "SELECT id, judul, tanggal, deskripsi, gambar FROM kabar_desa";
                                        ...
                                        if ($rowCount > 0) {
                                            ...
                                            while ($query->fetch()) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="detail_kabar.php?id=<?php echo urlencode($id); ?>" class="btn btn-info btn-sm">Detail</a>
                                                        <button class="btn btn-warning btn-sm" onclick="openEditModal('<?php echo $id; ?>', '<?php echo $judul; ?>', '<?php echo $tanggal; ?>', '<?php echo $deskripsi; ?>', '<?php echo $gambar; ?>')">Edit</button>
                                                        <a href="hapus_kabar.php?id=<?php echo urlencode($id); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus?')">Hapus</a>
                                                    </td>
                                                </tr>
                                                <?php
                                            }
